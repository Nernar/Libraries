 ...
 */
 class Connectivity {
	 ...
	 */
	setUrl(url: java.net.URL | string) {
	 ...
	 */
	getLength() {
		let justConnected = this.hasConnection()
		if (!justConnected) this.connect()
		let connection = this.getConnection()
		if (!(connection instanceof java.net.URLConnection)) {
			return -1
		}
		let length = connection.getContentLength()
		if (this.callback.hasOwnProperty("getLength")) {
			this.callback.getLength.call(this, length)
		}
		if (!justConnected) this.disconnect()
		return length
	}
...
namespace Connectivity {
	 ...
	 */
	export class Reader extends Connectivity {
		protected callback: {
			onUrlChanged?: (url: java.net.URL) => void
			onCreateConnection?: (connection: java.io.InputStream | java.net.URLConnection) => void
			onConnect?: (connection: java.io.InputStream | java.net.URLConnection) => void
		 ...
		 */
		toResult() {
			return this.getCurrentlyReaded()?.join("\n")
		}
		...
		read() {
			...
			this.result = []
			let reader = new java.io.BufferedReader(stream)
	 ...
	 */
	 export abstract class Writer extends Connectivity {
		protected callback: {
			onUrlChanged?: (url: java.net.URL) => void
			onCreateConnection?: (connection: java.io.InputStream | java.net.URLConnection) => void
			onConnect?: (connection: java.io.InputStream | java.net.URLConnection) => void
		...
		download() {
			...
			let output = this.getOutputStream()
			if (output == null) {
				// @ts-ignore
	 ...
	 */
	 export class Downloader extends Writer {
		protected callback: {
			onUrlChanged?: (url: java.net.URL) => void
			onCreateConnection?: (connection: java.io.InputStream | java.net.URLConnection) => void
			onConnect?: (connection: java.io.InputStream | java.net.URLConnection) => void
	 ...
	 */
	export function lengthUrl(address: string, callback?: (length: number) => void | object | any) {
		...
		let connect = new Connectivity(address)
		if (callback && typeof callback == "object") {
	 ...
	 */
	export function readUrl(address: string, callback: (readed: string) => void | object | any) {
		if (!Connectivity.isOnline()) {
			if (callback && typeof callback == "object") {
				// @ts-expect-error
				if (callback.hasOwnProperty("isNotConnected")) {
	 ...
	 */
	export function downloadUrl(address: string, path:string, callback: () => void | object | any) {
		if (!Connectivity.isOnline()) {
			if (callback && typeof callback == "object") {
				// @ts-expect-error
				if (callback.hasOwnProperty("isNotConnected")) {
